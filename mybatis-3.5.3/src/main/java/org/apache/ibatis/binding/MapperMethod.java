...
public class MapperMethod {
    ...
    switch (command.getType()) {
      ...
      case SELECT:
        ...
        if (method.returnsVoid() && method.hasResultHandler()) {
           ...
           * 第一步:获取statmentName(com.jayden.mapper.EmployeeMapper.findOne)
  ...
  public static class SqlCommand {
    /**
     * 接口的方法名全路径比如:com.jayden.mapper.DeptMapper.findDepts
     */
    ...
    public SqlCommand(Configuration configuration, Class<?> mapperInterface, Method method) {
      ...
      if (ms == null) {
        ...
        //把mappedStatmentID（com.jayden.mapper.EmpMapper.findEmp）
        name = ms.getId();
    ...
    private MappedStatement resolveMappedStatement(Class<?> mapperInterface, String methodName,
      ...
      //获取sql对应的statmentId(com.jayden.mapper.DeptMapper.findDepts)
