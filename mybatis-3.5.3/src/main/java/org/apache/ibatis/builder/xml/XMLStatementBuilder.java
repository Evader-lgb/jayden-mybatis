...
public class XMLStatementBuilder extends BaseBuilder {
  ...
  public void parseStatementNode() {
    ...
    // 判断insert|delete|update|select  节点是否配置了数据库厂商标注
    ...
    /**
     * 查看sql是否支撑自定义语言
     * <delete id="delEmployeeById" parameterType="int" lang="jaydenLang">
     <settings>
          <setting name="defaultScriptingLanguage" value="jaydenLang"/>
     </settings>
     */
     ...
     * com.jayden.mapper.Employee.saveEmployee!selectKey
     */
    keyStatementId = builderAssistant.applyCurrentNamespace(keyStatementId, true);
    /**
     *<insert id="saveEmployee" parameterType="com.jayden.entity.Employee" useGeneratedKeys="true" keyProperty="id">
    ...
    // 将insert|delete|update|select节点构建成mappedStatement对象
